...
\begin{center}
\centering
\caption{Calibration values for different scintillation screens: The absolute light yield per incident electrons (first column) and the saturation threshold as well as the resulting fitting parameter (middle and right column).}
\label{table:res}
