...
Saturation occurs because the probability that a certain atoms is excited multiple times before relaxing back into the ground state increases with the charge density.
...
We have tested degeneration or artificial aging effects of the phosphor layer caused by the electron dose applied to the screens during a dedicated long term run.
...
There have been already former calibration studies of scintillators some years ago by Glinec et al.\myCite{Glinec2006}, Buck et al.\myCite{Buck2010} and Nakamura et al.\myCite{Nakamura2011}.
...
In contrast to Ref. \myOnlineCite{Buck2010}, we see saturation starting  at peak charge densities in the order \si[per-mode = symbol]{\nano\coulomb\per\square\milli\meter}.
...
First we show that a realistic dose of irradiation leads to a significant decrease of the fluorescence efficiency.
