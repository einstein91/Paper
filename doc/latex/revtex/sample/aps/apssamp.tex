...
\author{T. Kurz}
 \altaffiliation[LMU Munich]{Physics Department, XYZ University.}%Lines break automatically or can be forced with \\
...
This article gives information about the absolute light yield of different scintillating screens used in laser-plasma experiments. 
The calibration was designed to investigate the light/charge--conversion and saturation effects of different screens.  
In order to reach the necessary electron fluence, the screens were exited by a focused electron beam, generating high charge density up to $5$ {nC}/mm$^2$ delivered from the ELBE linear accelerator. 
A three orders of magnitude linearity in light yield to charge conversion was found including a distinct saturation starting at $1000$ pC respectively $350$ pC/mm$^2$.
Additionally damage threshold and abrasion tests were made with \textit{KODAK BIOMAX MS}.   
...
In 1979 Tajima and Dawson founded the theoretical basis for laser--plasma experiments[].
Since these three decades the laser technology improved a lot and laser--systems now are able to operate in the petawatt--regime[], making it possible to accelerate electron bunch charges of several hundred pC to energies in the GeV--level.
The main advantage of such accelerators is the reduction of costs and     
